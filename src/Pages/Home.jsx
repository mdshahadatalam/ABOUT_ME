      ...
      <div className="container">
        <div className="row justify-center align-items-center">
          <div className="col-lg-6 fisrtHeader">
            <h1 className='text-4xl cursor-pointer headSc'
             data-aos="zoom-in"
             data-aos-duration="1500"
             >Hi I'am <span className='font-serif'>Front-End</span> Developer</h1>
          ...
          <div className="col-lg-6 justify-center align-items-center d-flex ">
            <Link to={'/images'}> <img className='img-fluid h-96 myImg shadow-md rounded-md cursor-pointer' data-aos="zoom-in" data-aos-duration="1500" src={my} alt="" /></Link>
          </div>
        </div>
    ...
    <section className='py-10 bg-[#c1baba] '>
      <div className="container">
        <h2 className='text-4xl font-bold text-center pb-5' 
         data-aos="zoom-in"
         data-aos-duration="1500">What I Do ?</h2>
        <div className="row">
          <div className="col-lg-4 pt-2">
            <div className='Box px-6 shadow-lg rounded bg-white text-black '
             data-aos="zoom-in" 
          ...
          <div className="col-lg-4 pt-2">
          <div className='Box px-6 shadow-lg bg-white text-black rounded '
           data-aos="zoom-in" 
           data-aos-duration="2000">
